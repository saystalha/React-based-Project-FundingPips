          ...
          <div className="hidden lg:flex flex-col justify-center p-12 bg-gradient-to-br from-card to-gray-900 relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted text-lg mb-8 leading-relaxed">
                Create your trading account to start tracking markets, building
                a portfolio, and executing strategies with institutional-grade
                tools.
              </p>

              <div className="bg-white/5 rounded-xl p-6 border border-white/5 backdrop-blur-sm">
                <strong className="text-electric block mb-4 uppercase text-xs tracking-wider font-bold">
                  Included Benefits
                </strong>
          ...
          <div className="flex flex-col justify-center p-8 md:p-12 bg-card w-full">
            <div className="text-center mb-8">
              ...
              <p className="text-muted text-sm">
                Start your trading journey for free
              </p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Global Submit Error Display */}
              {errors.submit && (
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1 space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="John"
                    className={`w-full px-4 py-3 bg-gray-900/50 border rounded-lg focus:outline-none focus:ring-1 focus:ring-electric transition-colors text-white placeholder-gray-600 ${
                      errors.firstName
                        ? "border-red-500/50 focus:border-red-500"
                        : "border-white/10 focus:border-electric"
                    }`}
                  />
                  {errors.firstName && (
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex justify-between items-center h-4">
                  ...
                  {passwordStrength && !errors.password && (
                    <div
                      className={`text-xs font-bold ml-auto ${getStrengthColor(
                        passwordStrength
                      )}`}
                    >
              ...
              <div className="space-y-1">
                ...
                {errors.agreeTerms && (
                  <div className="text-red-400 text-xs ml-8">
                    {errors.agreeTerms}
                  </div>
                )}
              </div>
            ...
            <div className="mt-8 text-center text-sm text-muted">
              ...
              <Link
                to="/signin"
                className="font-bold text-electric hover:text-white transition-colors"
              >
                Sign in
              </Link>
            </div>
